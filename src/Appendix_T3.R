#### Appendix Table 3: 2-year backward filling ####
...
texreg(
  ...
  file = write_path("updated-data/twoyearbackfill/negbin_outmigration_models_IN_texreg.tex"),
...
texreg(
  ...
  file = write_path("updated-data/twoyearbackfill/negbin_inmigration_models_IN_texreg.tex"),
  custom.model.names = c("No pop\nno GDP", "No pop\nw/ GDP", "No pop \nw/CF GDP",
                         "W/ pop\nno GDP", "Full model", "Full model w/CF GDP"),
  custom.coef.map = custom_coef_names,
...
texreg(
  list(count_nopop_nogdp_IN_interac_oa_in,
       ...
       count_wpop_wgdp_IN_interac_oa_out,
       count_wpop_wgdpcf_IN_interac_oa_out),
  file = write_path("updated-data/twoyearbackfill/negbin_combined_models_IN_texreg.tex"),
